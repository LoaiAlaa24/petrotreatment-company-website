...
const Media: React.FC = () => {
  ...
  const mediaItems: MediaItem[] = [
    {
      id: 0,
      title: 'فيديو تعريفي عن شركة بتروتريتمنت',
    ...
    {
      id: 1,
      title: 'بتروتريتمنت في الأخبار الحكومية',
      url: 'https://mped.gov.eg/singlenews?id=5545&lang=ar',
      source: 'وزارة التخطيط والتنمية الاقتصادية',
      type: 'news',
      icon: <Language sx={{ fontSize: 20 }} />,
    },
    {
      id: 2,
      title: 'منشور على فيسبوك - تغطية إعلامية',
    ...
    {
      id: 3,
      title: 'منشور على فيسبوك - أنشطة الشركة',
    ...
    {
      id: 4,
      title: 'بتروتريتمنت للخدمات البترولية تفوز بجائزة بيئية',
    ...
    {
      id: 5,
      title: 'منشور على فيسبوك - إنجازات الشركة',
    ...
    {
      id: 6,
      title: 'محافظ الإسماعيلية يُكرِّم الفائزين في مسابقة المشاريع الخضراء',
